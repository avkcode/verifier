...
// node_logs.go extends the tailer with kubelet-proxy log streaming so verifier can
// enrich 'verifier logs' sessions with node/system files alongside pod output.
package tailer
