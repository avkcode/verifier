...
func GenerateEd25519Key() (*BundleKey, error) {
	...
	return &BundleKey{
		APIVersion: "verifier.dev/bundle-key/v1",
		Type:       "ed25519",
...
func LoadBundleKey(path string) (*BundleKey, ed25519.PublicKey, ed25519.PrivateKey, error) {
	...
	case ed25519.PrivateKeySize:
		...
		return &BundleKey{APIVersion: "verifier.dev/bundle-key/v1", Type: "ed25519", PublicKey: base64.StdEncoding.EncodeToString(pub), PrivateKey: s}, pub, priv, nil
	case ed25519.SeedSize:
		priv := ed25519.NewKeyFromSeed(b)
		pub := priv.Public().(ed25519.PublicKey)
		return &BundleKey{APIVersion: "verifier.dev/bundle-key/v1", Type: "ed25519", PublicKey: base64.StdEncoding.EncodeToString(pub), Seed: s}, pub, priv, nil
	default:
...
func signManifest(priv ed25519.PrivateKey, manifestJSON []byte) (*BundleSignature, error) {
	...
	return &BundleSignature{
		APIVersion:     "verifier.dev/bundle-signature/v1",
