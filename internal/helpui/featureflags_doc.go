...
import (
	...
	"verifier/internal/featureflags"
)
...
func featureFlagsDoc() string {
	...
	b.WriteString("Enable per invocation with `verifier --feature <name>` (repeatable/comma-separated), via config (`feature: [\"<name>\"]`), or env vars `VERIFIER_FEATURE_<FLAG>`.\n\n")
